...
namespace PumpingSystem.Domain
{
    public class ApplicationService
    {
        ...
        public void SendDataWaterTank(MsgWaterTankData[] msgs)
        {
            LocalRepository localRepository = LocalRepository.GetInstance();
            ...
            Task.Factory.StartNew(() =>
            {
                try
                {
                    localRepository.Tanks[(int)WaterTankPosition.Tank1].MinLevel = msgs[(int)WaterTankPosition.Tank1].MinLevel;
                    localRepository.Tanks[(int)WaterTankPosition.Tank2].MinLevel = msgs[(int)WaterTankPosition.Tank2].MinLevel;

                    Program.UartService.SendMessage(new MsgTelegram201(msgs[(int)WaterTankPosition.Tank1].MinLevel, msgs[(int)WaterTankPosition.Tank2].MinLevel));
                }
                catch (Exception e)
                {
                    //TODO: Implementar framework de log
